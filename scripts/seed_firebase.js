...
async function seed() {
    console.log('--- STARTING AI-READY DATABASE SEEDING ---');
    ...
    // Parse Schemes (Cols G to EW) -> Index 6 to 152
    ...
    for (let rowIdx = 11; rowIdx < data.length; rowIdx++) {
        ...
        // Loop through schemes to extract boq_qty, rate, amount
        ...
        for (const scheme of schemes) {
            ...
            if (boq_qty || swsm_rate || boq_amount) {
                scheme.boq_items[cleanItemNo.replace(/\./g, '_')] = {
                    dept: cleanDept,
                    parent_heading: current_active_heading || '',
