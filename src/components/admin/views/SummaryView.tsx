        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-[1600px] mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex items-center gap-2 mt-3">
                                ...
                                <span className="text-xs font-medium text-slate-400">vs ₹75.5 Cr prev</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-8 grid grid-cols-2 lg:grid-cols-5 gap-4">
                    {[
                        { title: "TOTAL SCHEMES", value: "142", icon: <Factory size={16} className="text-blue-500" /> },
                        { title: "ACTIVE SCHEMES", value: "98", icon: <TrendingUp size={16} className="text-emerald-500" /> },
                        { title: "TOTAL COMPLETED", value: "34", icon: <CheckCircle2 size={16} className="text-indigo-500" /> },
                        { title: "UPCOMING", value: "10", icon: <AlertCircle size={16} className="text-amber-500" /> },
                        { title: "TRANSITION TO O&M", value: "22", icon: <Zap size={16} className="text-rose-500" /> }
                    ].map((kpi, idx) => (
                        <div key={idx} className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-wider">{kpi.title}</p>
                            </div>
                        </div>
                    ))}
                </div>
                                        ...
                                        <tr key={row.id} className="hover:bg-slate-50/80 transition-colors group">
                                            <td className="p-3">
                                                <div className="flex items-center gap-3">
                                                    <div className="p-1.5 bg-slate-100 text-slate-500 rounded-md group-hover:bg-blue-100 group-hover:text-blue-600 transition-colors">{row.icon}</div>
                                                    <span className="font-bold text-sm text-slate-700">{row.item}</span>
                                                </div>
                                            </td>
